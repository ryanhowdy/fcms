...
class InstallController extends Controller
{
    ...
    public function configurationStore(Request $request)
    {
        $insertParams = [
            ...
            [
                'link'       => _gettext('Calendar'),
                'route_name' => 'calendar',
                'group'      => 1,
                'order'      => 3,
            ],
            [
                'link'       => _gettext('Members'),
                'route_name' => 'members',
                'group'      => 1,
                'order'      => 4,
            ],
            [
                'link'       => _gettext('Address Book'),
                'route_name' => 'addressbook',
                'group'      => 1,
                'order'      => 5,
            ],
            [
                'link'       => _gettext('Communicate'),
                'route_name' => null,
                'group'      => 2,
                'order'      => 1,
            ],
            [
                'link'       => _gettext('Discussions'),
            ...
            [
                'link'       => _gettext('Photos'),
                'route_name' => 'photos',
                'group'      => 3,
                'order'      => 2,
            ],
            [
                'link'       => _gettext('Videos'),
                'route_name' => 'videos',
                'group'      => 3,
                'order'      => 3,
            ],
            ...
            [
                'link'       => _gettext('Upgrade'),
                'route_name' => 'admin.upgrade',
                'group'      => 5,
                'order'      => 2,
            ],
            [
                'link'       => _gettext('Configuration'),
            ...
            [
                'link'       => _gettext('Facebook'),
                'route_name' => 'admin.facebook',
                'group'      => 5,
                'order'      => 6,
            ],
            [
                'link'       => _gettext('Google'),
                'route_name' => 'admin.google',
                'group'      => 5,
                'order'      => 7,
            ],
            [
                'link'       => _gettext('Instagram'),
        ...
        $communicatePlugins = [
            'familynews' => [
                'link'       => _gettext('Family News'),
                'route_name' => 'familynews',
                'group'      => 2,
            ],
            'prayers' => [
                'link'       => _gettext('Prayer Concerns'),
                'route_name' => 'prayers',
                'group'      => 2,
            ],
        ];
        $sharePlugins = [
            'recipes' => [
                'link'       => _gettext('Recipes'),
                'route_name' => 'recipes',
                'group'      => 3,
            ],
            'familytree' => [
                'link'       => _gettext('Family Tree'),
                'route_name' => 'familytree',
                'group'      => 3,
            ],
            'documents' => [
                'link'       => _gettext('Documents'),
