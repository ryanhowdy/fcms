...
if (isset($_GET['uid'])) {
    ...
    if (ctype_digit($_GET['uid'])) {
        echo '
    <div id="login_box">
        <h1 id="reset_header">'._('Account Activation').'</h1>';
        ...
        if (isset($_GET['code'])) {
            ...
            if ($row['activate_code'] == $_GET['code']) {
                ...
                echo '
        <p><b>'._('Alright!').'</b></p>
        <p>'._('Your account is now active.').'</p>
        <p><a href="index.php">'._('You can now login and begin using the site.').'</a></p>
        <meta http-equiv=\'refresh\' content=\'5;URL=index.php\'>';

            // Code is invalid
            } else {
                echo '
        <p><b>'._('Invalid Activation Code!').'</b></p>
        <p>'._('Your account could NOT be activated').'</p>';
            }
