...
<div class="p-5">
    ...
    <form class="p-5 border rounded bg-white" action="{{ route('calendar.create') }}" method="post">
        @csrf
        <h2 class="mb-3">{{ __('Create New Event') }}</h2>
    @if ($errors->any())
    ...
    @endif
        ...
        <div class="more pt-3 d-none">
            ...
            <div class="mb-3 d-flex">
                ...
                <div class="">
                    ...
                    <label class="btn btn-outline-purple" for="repeat-yearly">{{ __('Repeat Every Year') }}</label>
                </div>
            </div>
            <div class="mb-3 d-flex">
                ...
                <div class="">
                    ...
                    <label class="btn btn-outline-purple" for="private">{{ __('Private') }}</label>
                </div>
            </div>
            <div class="mb-3 d-flex">
                ...
                <div class="">
                    ...
                    <label class="btn btn-outline-purple" for="invite">{{ __('Invite Guests') }}</label>
                </div>
            </div>
        ...
        <div class="pt-5">
            ...
            <a href="#" class="btn btn-secondary">{{ __('More Options') }}</a>
        </div>
    </form>
