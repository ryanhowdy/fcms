...
<link rel="shortcut icon" href="<?php echo $TMPL['path']; ?>ui/themes/favicon.ico"/>
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/blue-chrome/style.css"/>
<!--[if IE 5.5]>
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/blue-chrome/ie55.css"/>
<![endif]-->
<!--[if IE 6]>
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/blue-chrome/ie6.css"/>
<![endif]-->
<!--[if IE 7]>
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/blue-chrome/ie7.css"/>
<![endif]-->
<!--[if IE 8]>
<link rel="stylesheet" type="text/css" href="<?php echo $TMPL['path']; ?>ui/themes/blue-chrome/ie8.css"/>
<![endif]-->
<script type="text/javascript" src="<?php echo $TMPL['path']; ?>ui/js/prototype.js"></script>
<script type="text/javascript" src="<?php echo $TMPL['path']; ?>ui/js/fcms.js<?php echo '?'.time();?>"></script>
