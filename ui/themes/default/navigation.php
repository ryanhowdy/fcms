    <div id="topmenu">
        <ul id="navigation">
            <li class="main">
                <a class="main" href="<?php echo $TMPL['path'].'index.php';?>"><?php echo T_pgettext('The beginning or starting place.', 'Home');?></a>
            </li>
...
<?php if (isset($TMPL['nav-link'][6])): ?>
            <li class="main">
                <a class="main" href="<?php echo $TMPL['path'].'admin/index.php';?>"><?php echo T_('Administration');?></a>
            </li>
<?php endif; ?>
        </ul>
    </div>
