	...
	<div id="content">
		<div id="gallery" class="centercontent">
			...
			if(isset($_POST['add_editphoto'])) {
				$sql = "UPDATE `fcms_gallery_photos` SET category='" . addslashes($_POST['category']) . "', caption='" . addslashes($_POST['photo_caption']) . "' WHERE id=" . $_POST['photo_id'];
