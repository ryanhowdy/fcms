...
diag('getDocumentsById');

plan(7);

connectDatabase();

$bad_id  = getDocumentsById(0);
$good_id = getDocumentsById(1);
$good_id_count   = getDocumentsById(1, 'count');
$good_id_percent = getDocumentsById(1, 'percent');
$good_id_array   = getDocumentsById(1, 'array');
