...
$bad_id  = getPhotosById(0);
$good_id = getPhotosById(1);
$good_id_count   = getPhotosById(1, 'count');
$good_id_percent = getPhotosById(1, 'percent');
$good_id_array   = getPhotosById(1, 'array');
